...
the [African Bird Atlas Project](http://www.birdmap.africa/). Some of its functionality is
under development, so use with caution and please send any feedback!
...
our detection data must be uploaded as spatial objects. For example to upload all ABAP pentads (remember
